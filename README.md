...
本项目支持小红书总浏览量、点赞量、收藏量、评论数、转发数一键查询。忽略小红书创作服务平台半年限制，支持所有笔记数据的导出，支持展示个人主页历史浏览量 Top 10 笔记。
...
XHS Creator Analytics 可以读取小红书创作者中心中的已发布笔记数据，并汇总全部笔记的：
...
适合需要进行小红书账号数据汇总、历史笔记统计、总浏览量查询的创作者使用。

## 功能

- 自动分页获取当前账号的全部笔记，包括公开可见/仅互关好友可见/仅自己可见
- 汇总小红书总浏览量、点赞、收藏、评论和转发
- 展示浏览量 Top 10 笔记
- 显示抓取总数和实时进度
